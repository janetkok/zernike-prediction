...
def train(model, data_loader, criterion, optimizer, scaler, epoch_start=0,num_epochs=5, saver=None, output_dir='',save_every=10):
...
def infer_subset(model, data_loader, criterion, optimizer, output_dir='',num_zernike=25,gen_aberration=None):
...
def main():
    ...
    if args.infer:
        ...
        train(model,dataloader , criterion, optimizer, scaler, epoch_start=epoch_start,num_epochs=args.epochs,saver=saver,output_dir=output_dir,save_every=args.save_every)
